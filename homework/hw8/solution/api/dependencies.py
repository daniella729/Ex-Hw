...
def get_account_repository() -> AccountRepository:
    return AccountRepository(CsvFileAccessor("accounts.csv"))


def get_category_repository() -> CategoryRepository:
    return CategoryRepository(CsvFileAccessor("categories.csv"))


def get_transaction_repository() -> TransactionRepository:
    return TransactionRepository(CsvFileAccessor("transactions.csv"))


def get_transfer_repository() -> TransferRepository:
    return TransferRepository(CsvFileAccessor("transfers.csv"))
